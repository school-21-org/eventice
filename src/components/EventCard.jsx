...
export const EventCard = ({ name, time, date, description }) => {
  console.log('name, time, date, description', name, time, date, description);
  return (<div className="font-bellota select-none border border-black rounded-xl xl:w-2/5 py-2 px-4">
